...
public class Trou_noir_effect extends Effect{
	...
	public Trou_noir_effect(AbstractModelPartie partie,Fleche _ref_fleche,int _mouv_index, int current_frame,Vector2d _normalCollision,Point _pointCollision,
			Point _correctedPointCollision)
	{
		...
		subTypeMouv = null;
		setMouvement(new Trou_noir_idle(subTypeMouv,partie.getFrame()));
