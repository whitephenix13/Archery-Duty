...
public interface InterfaceConstantes {
	...
	static int DEBUG_TIME_VERBOSE=0;// 0 for none, 1 for more , ...until 5
	static boolean DEBUG_TIME_ONLY_LOG_SLOW_STEPS = true;//print only steps that take some time to execute (ie: >1sec) 
